...
| explain | Explain a finding or coverage state | no | clean-docs explain --format json |
...
| eval | Score human tasks and replayable agent round trips | with --history or live recording | clean-docs eval evals/tasks.yml |
