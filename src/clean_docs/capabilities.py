...
CLI_REFERENCE = (
    ...
    {"command": "residue status", "job": "Report whether private residue matching is active", "writes": "no", "example": "clean-docs residue status"},
    {"command": "residue init-local", "job": "Create a permission-restricted private residue template", "writes": "yes", "example": "clean-docs residue init-local"},
    ...
    {"command": "review lifecycle", "job": "Track assessment-only candidate status with typed evidence", "writes": "with init or transition", "example": "clean-docs review lifecycle --help"},
    {"command": "review lifecycle init", "job": "Initialize a lifecycle record for one candidate set", "writes": "yes", "example": "clean-docs review lifecycle init --input review.json --out lifecycle.json"},
    {"command": "review lifecycle transition", "job": "Apply one evidence-backed candidate transition", "writes": "yes", "example": "clean-docs review lifecycle transition --help"},
    {"command": "review lifecycle check", "job": "Check a lifecycle record against its candidate set", "writes": "no", "example": "clean-docs review lifecycle check --input review.json --state lifecycle.json"},
