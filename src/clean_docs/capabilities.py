...
CLI_REFERENCE = (
    ...
    {"command": "explain", "job": "Explain a finding or coverage state", "writes": "no", "example": "clean-docs explain --format json"},
    ...
    {"command": "eval", "job": "Score human tasks and replayable agent round trips", "writes": "with --history or live recording", "example": "clean-docs eval evals/tasks.yml"},
