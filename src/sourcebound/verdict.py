...
from sourcebound.impact import ImpactPlan, build_impact_plan
from sourcebound.inventory import DirectPolicyReport
from sourcebound.models import ClaimBinding
from sourcebound.outcomes import RepositoryEvidence, collect_repository_evidence
from sourcebound.sensitivity import RECEIPT_SCHEMA, load_json_object
...
class PullRequestVerdict:
    ...
    def _payload(self) -> dict[str, object]:
        ...
        direct_policy = inventory.direct_policy or DirectPolicyReport(
            configured=False,
            required=0,
            satisfied=0,
            gaps=(),
        ...
        return {
            ...
            "execution": {
                ...
                "repository_processes_started": False,
                "plugins": "skipped",
            ...
            "coverage": {
                ...
                "direct_policy": direct_policy.as_dict(),
